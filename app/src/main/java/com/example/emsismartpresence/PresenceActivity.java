...
public class PresenceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // --- EMSI Moulay Youssef ---
        List<Groupe> groupesMoulayYoussef = Arrays.asList(
                new Groupe("Groupe 1", Arrays.asList(
                        new Student("Yassine El Amrani"),
                        new Student("Sara Benali"),
                        new Student("Omar El Idrissi"),
                        new Student("Imane Berrada"),
                        new Student("Mohamed El Fassi"),
                        new Student("Salma Chafai")
                )),
                new Groupe("Groupe 2", Arrays.asList(
                        new Student("Hicham El Ghazali"),
        ...
        centres.add(new Centre("EMSI Moulay Youssef", groupesMoulayYoussef));
